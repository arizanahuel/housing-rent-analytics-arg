...
def main():
    ...
    nombre_archivo_datos = f'datos_scrape_argenprop_vicente_lopez{timestamp}.csv'
    ...
    for i in range(1, pages + 1):
        ...
        try:
            response = requests.get("https://www.argenprop.com/departamento-alquiler-localidad-vicente-lopez-orden-masnuevos-pagina-" + str(i), headers={'User-Agent': 'Chrome'})
