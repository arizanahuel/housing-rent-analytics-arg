...
def main():
    ...
    nombre_archivo_datos = f'datos_scrape_argenprop_gral_san_martin{timestamp}.csv'
    ...
    for i in range(1, pages + 1):
        ...
        try:
            response = requests.get("https://www.argenprop.com/departamento-alquiler-localidad-general-san-martin-orden-masnuevos-pagina-" + str(i), headers={'User-Agent': 'Chrome'})
